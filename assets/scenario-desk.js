/* Close With Ty — Commercial Scenario Desk
...
(() => {
  ...
  function generatePdf(inputs, result, checklist) {
    ...
    doc.text('CLOSE WITH TY · COMMERCIAL SCENARIO DESK', margin, y);
    ...
    doc.setFontSize(10);
    doc.setTextColor(...MID);
    doc.text('Tyler Nagorski · Senior Mortgage Consultant · Element Mortgage, a division of American Pacific Mortgage Corp.', margin, y);
    y += 14;
